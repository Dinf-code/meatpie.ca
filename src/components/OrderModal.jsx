      ...
      <div style={{ marginBottom: '24px' }}>
        ...
        <div style={{ marginBottom: '16px' }}>
          ...
          <input
            ...
            style={{ width: '100%', padding: '12px', borderRadius: '8px',  boxSizing: 'border-box', border: formErrors.name ? '2px solid #EF4444' : '1px solid rgba(197,148,159,0.3)', backgroundColor: 'rgba(197,148,159,0.05)', color: '#F5E6E8', fontSize: '14px', outline: 'none' }}
          />
        ...
        <div style={{ marginBottom: '16px' }}>
          ...
          <input
            ...
            style={{ width: '100%', padding: '12px', borderRadius: '8px',  boxSizing: 'border-box', border: formErrors.email ? '2px solid #EF4444' : '1px solid rgba(197,148,159,0.3)', backgroundColor: 'rgba(197,148,159,0.05)', color: '#F5E6E8', fontSize: '14px', outline: 'none' }}
          />
        ...
        <div style={{ marginBottom: '16px' }}>
          ...
          <input
            ...
            style={{ width: '100%', padding: '12px', borderRadius: '8px',  boxSizing: 'border-box', border: formErrors.phone ? '2px solid #EF4444' : '1px solid rgba(197,148,159,0.3)', backgroundColor: 'rgba(197,148,159,0.05)', color: '#F5E6E8', fontSize: '14px', outline: 'none' }}
          />
        ...
        {deliveryMethod === 'delivery' && (
          <div style={{ marginBottom: '16px' }}>
            ...
            <textarea
              ...
              rows="3"
              style={{ width: '100%', padding: '12px', borderRadius: '8px', boxSizing: 'border-box', border: formErrors.address ? '2px solid #EF4444' : '1px solid rgba(197,148,159,0.3)', backgroundColor: 'rgba(197,148,159,0.05)', color: '#F5E6E8', fontSize: '14px', outline: 'none', resize: 'vertical', fontFamily: 'inherit' }}
            />
        ...
        <div style={{ marginBottom: '16px' }}>
          ...
          <textarea
            ...
            rows="2"
            style={{ width: '100%', padding: '12px', borderRadius: '8px',  boxSizing: 'border-box', border: '1px solid rgba(197,148,159,0.3)', backgroundColor: 'rgba(197,148,159,0.05)', color: '#F5E6E8', fontSize: '14px', outline: 'none', resize: 'vertical', fontFamily: 'inherit' }}
          />
        </div>
      </div>
...
<div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
  <button
    ...
    style={{
      flex: '1', minWidth: '120px', padding: '14px 24px',
      borderRadius: '12px', border: '2px solid rgba(197,148,159,0.5)',
      backgroundColor: 'transparent', color: '#F5E6E8',
  ...
  <button
    ...
    disabled={isLoading}
    style={{
      flex: '2', minWidth: '160px', padding: '14px 32px',
